...
char *StateToString(int state)
{
    switch (state)
    {
        ...
        case MOVE_TOWARDS_TURN: return "towards turn sign";
...
int main(int argc, char **argv)
{
    ...
    while (ros::ok())
    {
        ...
        // ROS_INFO("d: %0.3f, a: %0.3f, z: %0.3f", error_dist, error_angle * 180 / CV_PI, cmd_vel.angular.z);
